...
public class NoticeService {
    ...
    // 게시글 검색 조회
    @Transactional
    public void searchNoticesTitle(SearchNoticesTitleRequestDto searchNoticesTitleRequestDto){
    ...
    // 게시글 생성
    @Transactional
    public void createBoards(NoticeCreateRequestDto noticeCreateRequestDto){
    ...
    @Transactional
    public void editBoardsContent(Long id, NoticeEditRequestDto noticeEditRequestDto){
    ...
    // 작성자 조회
    @Transactional
    public void searchNoticesWriter(SearchNoticesWriterRequestDto searchNoticesWriterRequestDto){
    ...
    // 날짜별 조회
    @Transactional
    public void searchNoticesDate(SearchNoticesDateRequestDto searchNoticesDateRequestDto){
